...
function EditStudent()
{
    ...
    const {id} = useParams();
    useEffect(()=>{
        Axios.get("https://crud-operation-138s.onrender.com/students/update-student/" + id)
        .then((res)=>{
            if(res.status === 200){
    ...
    const handleSubmit = () =>{
        ...
        Axios.put("https://crud-operation-138s.onrender.com/students/update-student/"+ id, data)
        .then((res)=>{
            if(res.status === 200)
